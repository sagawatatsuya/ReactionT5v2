...
CUDA_VISIBLE_DEVICES=3 python finetune.py \
    ...
    --similar_reaction_data_path='/data1/ReactionT5_neword/task_yield/output_test1_test/top5_similar_reactions.csv' \
    --model_name_or_path='/data1/ReactionT5_neword/task_yield' \
    --epochs=200 \
    --batch_size=16 \
    --input_max_length=300 \
...
CUDA_VISIBLE_DEVICES=3 python finetune.py \
    ...
    --similar_reaction_data_path='/data1/ReactionT5_neword/task_yield/output_test2_test/top5_similar_reactions.csv' \
    --model_name_or_path='/data1/ReactionT5_neword/task_yield' \
    --epochs=200 \
    --batch_size=16 \
    --input_max_length=300 \
...
CUDA_VISIBLE_DEVICES=3 python finetune.py \
    ...
    --similar_reaction_data_path='/data1/ReactionT5_neword/task_yield/output_test3_test/top5_similar_reactions.csv' \
    --model_name_or_path='/data1/ReactionT5_neword/task_yield' \
    --epochs=200 \
    --batch_size=16 \
    --input_max_length=300 \
...
CUDA_VISIBLE_DEVICES=3 python finetune.py \
    --train_data_path='/data1/ReactionT5_neword/data/C_N_yield/MFF_Test4/train.csv' \
    --valid_data_path='/data1/ReactionT5_neword/data/C_N_yield/MFF_Test4/test.csv' \
    --similar_reaction_data_path='/data1/ReactionT5_neword/task_yield/output_test4_test/top5_similar_reactions.csv' \
    --model_name_or_path='/data1/ReactionT5_neword/task_yield' \
    --epochs=200 \
    --batch_size=16 \
    --input_max_length=300 \
